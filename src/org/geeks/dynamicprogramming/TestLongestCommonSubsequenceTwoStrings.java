...
public class TestLongestCommonSubsequenceTwoStrings {
	...
	public static int lcsDynamic(char[] str1, char[] str2) {
	  ...
	  public static void main(String args[]){
		  ...
		  System.out.println("Using Dvide and Conquer");
		  int result =  lcs(str1.toCharArray(), str2.toCharArray(),0, 0);
		  System.out.println(result);
		  
		  System.out.println("Using Dynamic");
		  int result2 =  lcsDynamic(str1.toCharArray(), str2.toCharArray());
		  System.out.println(result);
	  }
