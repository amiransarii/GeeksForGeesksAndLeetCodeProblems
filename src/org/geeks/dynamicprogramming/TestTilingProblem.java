 ...
 * 
 * @author amir.ansari
 *Given a “2 x n” board and tiles of size “2 x 1”, count the number of ways to tile the 
 *given board using the 2 x 1 tiles. A tile can either be placed horizontally i.e., 
 ...
 */
public class TestTilingProblem {
