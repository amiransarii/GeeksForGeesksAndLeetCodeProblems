...
public class TestLongestCommonPrefix {
	...
	/**
	 * In this algorithm, a divide and conquer approach is discussed. We first divide the arrays of string 
	 * into two parts. Then we do the same for left part and after that for the right part. We will do it 
	 * until and unless all the strings become of length 1. Now after that, we will start conquering by returning
	 *  the common prefix of the left and the right strings.
